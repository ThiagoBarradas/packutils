...
namespace PackUtils.Test
{
    public static class StringUtilityTest
    {
        ...
        [InlineData("camelcase", "Hello123asd", "hello123asd")]
        ...
        [InlineData("snake", "Hello123", "hello123")]
        [InlineData("snake", "Hello123asd", "hello123asd")]
        ...
        [InlineData("snakecase", "Hello123", "hello123")]
        [InlineData("snakecase", "Hello123asd", "hello123asd")]
        [InlineData("snakecase", "HelloXXX", "hello_xxx")]
        [InlineData("snakecase", "HelloXXXs", "hello_xx_xs")]
        ...
        [InlineData("huhuhehe", "hello_sir", "hello_sir")]
        ...
        [InlineData("Test", "test")]
        [InlineData("TestTTT", "test_ttt")]
        [InlineData("TestTTTs", "test_tt_ts")]
        [InlineData("LineLine123123", "line_line123123")]
        [InlineData("LineLine123123asd", "line_line123123asd")]
